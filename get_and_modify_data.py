...
def mapped_headers():
    ...
    for site in site_names:
        ...
        column_site_mappings = {col: {val: site_column_mapping[val] if val in site_column_mapping else val for val in site_data_col_renamed_df[col].unique()} for col in site_data_col_renamed_df.columns if col not in exclude_col}
